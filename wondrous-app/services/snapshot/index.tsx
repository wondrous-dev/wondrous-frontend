...
import { GET_SPACE, GET_SNAPSHOT, SET_SPACE, SET_SNAPSHOT_PROPOSAL } from './gql';
    ...
    if (onboarding !== Onboarding.Ready) {
      if (onboarding === Onboarding.NotFound) {
        setSnapshotErrorElement(
          <span>
            Snapshot '{id}' not found. Please enter a valid Snapshot Space ENS or follow{' '}
            <Link href={SNAPSHOT_DOCS} target="blank">
              Snapshot's guide on how to create one
            </Link>
          </span>
        );
