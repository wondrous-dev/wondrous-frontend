...
import {
  CREATE_TASK_PROPOSAL_COMMENT,
  DELETE_TASK_PROPOSAL_COMMENT,
...
export const CommentBox = (props) => {
  ...
  const [createTaskProposalComment] = useMutation(
    CREATE_TASK_PROPOSAL_COMMENT,
    {
...
const CommentItem = (props) => {
  ...
  const [deleteTaskProposalComment] = useMutation(
    DELETE_TASK_PROPOSAL_COMMENT,
    {
      refetchQueries: ['getTaskProposalComments'],
    }
  ...
  return (
    <CommentItemContainer>
      {actorProfilePicture ? (
        <CommentProfilePicture src={actorProfilePicture} />
      ) : (
        <DefaultCommentProfilePicture />
      )}
      <div>
...
export const CommentList = (props) => {
  ...
  const [getTaskProposalComments] = useLazyQuery(
    GET_COMMENTS_FOR_TASK_PROPOSAL,
    {
      onCompleted: (data) => {
