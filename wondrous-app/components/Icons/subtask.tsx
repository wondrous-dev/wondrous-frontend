  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="none" viewBox="0 0 25 25">
      ...
      <path
        ...
        d="M12.912 14.527l1.133 1.134 2.287-2.287"
      ></path>
      <rect
        width="8"
        height="8"
      ...
      <path
        ...
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M10.286 14.755H8.594a1 1 0 01-1-1v-3.237"
      ></path>
      <circle cx="7.594" cy="8.503" r="1.508" stroke="#C4C4C4" strokeLinecap="round" strokeLinejoin="round"></circle>
    </svg>
  );
};
...
export const SubtaskDarkIcon = ({ fill = '#0F0F0F', width = '25', height = '25' }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill="none" viewBox="0 0 25 25">
      ...
      ></path>
      <circle cx="7.301" cy="8.347" r="1.508" stroke="#707070" strokeLinecap="round" strokeLinejoin="round"></circle>
    </svg>
  );
};
