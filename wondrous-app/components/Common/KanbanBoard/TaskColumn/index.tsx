...
interface ITaskColumn {
  ...
  section: Array<any>;
  onOpen: () => any;
  onColumnSectionToggle: (isOpen: boolean) => unknown;
}
...
const TaskColumn = (props: ITaskColumn) => {
  const { cardsList, moveCard, status, section, onColumnSectionToggle } = props;
  ...
  return (
    <TaskColumnContainer>
      ...
      <ColumnSection section={section} setSection={() => {}} onToggle={onColumnSectionToggle} />
