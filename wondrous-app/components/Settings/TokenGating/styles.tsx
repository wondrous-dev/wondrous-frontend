...
import { background, blueColors, white, blackColors, greyColors } from 'theme/colors';
...
export const TokenGatingAutocompleteTextfieldButton = styled(TokenGatingTextfieldButton)`
  && {
    ...
    border-left: 1px solid ${greyColors.grey85};
  }
`;
...
export const TokenGatingTextfieldButtonUp = styled(TokenGatingTextfieldButton)`
  && {
    ...
    border-right: 1px solid ${greyColors.grey85};
  }
`;
...
export const TokenGatingAutocompleteListItem = styled(ListItem)`
  && {
    background: ${greyColors.grey100} !important; // There's a global background with '!important', so we need to override it
    height: 50px;
    font-family: 'Space Grotesk';
    font-size: 14px;
    font-weight: 400;
