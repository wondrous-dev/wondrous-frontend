...
export const SettingsSidebarTabsListItemButtonWrapper = styled.div`
	...
	border-radius: 2px;
	background: ${(props) =>
		props.active ? GradientHighlightHorizontal : 'transparent'};
`
...
export const SettingsSidebarLogoutButtonText = styled(
...
export const GeneralSettingsDAODescriptionInput = styled(
