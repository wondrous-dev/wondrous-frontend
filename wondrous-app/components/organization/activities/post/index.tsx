    ...
    <PostsContainer>
      <PostComponent>
        <PostBlock>
          ...
          <PostAuthorText>
            Mia absolutely killed the pitch deck. We had investors comment on how clean all of the data is. Great work!
          </PostAuthorText>
        </PostBlock>
        <PostTask>
          <PostTaskHeader>
            <PostTaskHeaderAuthor>
              ...
              <PostTaskHeaderText>
                <PostTaskHeaderAuthorNickname>Mia Elekai</PostTaskHeaderAuthorNickname>
                completed a task
              </PostTaskHeaderText>
            </PostTaskHeaderAuthor>

            <CardHeaderCategory compensation={{ amount: 3200, currency: 'wonder' }} status={TASK_STATUS_DONE} />
          </PostTaskHeader>
          <PostTaskContent>
            <PostTaskTextBlock>
              <PostTaskTitle>Complete investment deck</PostTaskTitle>
              <PostTaskText>Maecenas hendrerit porttitor integer viverra lorem metus et in.</PostTaskText>
            </PostTaskTextBlock>
            <PostTaskImageBlock>
              <PostLeftImage>
