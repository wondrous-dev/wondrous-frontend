...
import { SOCIAL_MEDIA_FACEBOOK, SOCIAL_MEDIA_LINKEDIN, SOCIAL_MEDIA_TWITTER } from 'utils/constants';
...
const About = (props) => {
  const { lastCompletedTask = {}, organizations = [], profileInfo = {}, pods = [] } = props;
    ...
    <Wrapper>
      <AboutSection>
            ...
            <AboutInfoTableRowContent>
              {skills.map((skill) => (
                <AboutInfoTableRowContentItem key={skill}>
                  <AboutInfoTableRowContentItemHashtag>{skill}</AboutInfoTableRowContentItemHashtag>
                </AboutInfoTableRowContentItem>
              ))}
            </AboutInfoTableRowContent>
          </AboutInfoTableRow>
        ...
        <AboutInfoContainer>
          <AboutInfoBlock>
            <AboutInfoBlockHeader>
              <AboutInfoBlockHeaderAmount>{organizations.length}</AboutInfoBlockHeaderAmount>
              <AboutInfoBlockHeaderText>Organisations</AboutInfoBlockHeaderText>
            </AboutInfoBlockHeader>
            <AboutInfoBlockContent>
              {organizations.map((organization) => (
                <AboutOrganisationsCard key={organizations.id} {...organization} />
              ))}
            </AboutInfoBlockContent>
          </AboutInfoBlock>
          ...
          <AboutInfoBlock>
            <AboutInfoBlockHeader>
              <AboutInfoBlockHeaderAmount>{pods.length}</AboutInfoBlockHeaderAmount>
          ...
          <AboutInfoBlock>
            <AboutInfoBlockHeader>
              <AboutInfoBlockHeaderAmount>{completedTasks}</AboutInfoBlockHeaderAmount>
