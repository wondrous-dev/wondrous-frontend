...
export const HeaderMembers = styled.div`
	display: flex;
	justify-content: space-between;
	align-items: center;
	cursor: pointer;
...
export const HeaderMembersAmount = styled(Typography)`
	&& {
		font-weight: 500;
		font-size: 15px;
		line-height: 150%;
...
export const HeaderMembersText = styled(HeaderMembersAmount)`
	&& {
		color: #6c6c6c;
	}
`

export const HeaderMilestones = styled.div`
	display: flex;
	justify-content: space-between;
	align-items: center;
	cursor: pointer;
...
export const HeaderMilestonesAmount = styled(Typography)`
	&& {
		font-weight: 500;
		font-size: 15px;
		line-height: 150%;
...
export const HeaderMilestonesText = styled(HeaderMilestonesAmount)`
	&& {
		color: #6c6c6c;
	}
`

export const HeaderCompletedTasks = styled(HeaderMembers)``

export const HeaderCompletedTasksAmount = styled(HeaderMembersAmount)``

export const HeaderCompletedTasksText = styled(HeaderMilestonesText)`
	&& {
		color: #6c6c6c;
	}
`
