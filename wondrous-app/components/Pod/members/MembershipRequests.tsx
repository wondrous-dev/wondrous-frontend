...
type Props = {
  podUserMembershipRequests: Array<any>;
  hasMore: boolean;
...
const MembershipRequests = (props: Props) => {
  const { podUserMembershipRequests, hasMore, handleShowMoreRequests, declineRequest, approveRequest } = props;
  ...
  return (
    <RequestsContainer>
      ...
      <RequestCount>{podUserMembershipRequests?.length} Requests</RequestCount>
      <MemberRequestsList>
