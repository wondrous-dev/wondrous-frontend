  ...
  return (
    <AboutSection>
      ...
      <AboutInfoContainer>
        <AboutInfoBlock>
          <AboutInfoBlockHeader>
            <AboutInfoBlockHeaderAmount>{milestones.length}</AboutInfoBlockHeaderAmount>
        ...
        <AboutInfoBlock>
          <AboutInfoBlockHeader>
            <AboutInfoBlockHeaderAmount>{members.length}</AboutInfoBlockHeaderAmount>
        ...
        <AboutInfoBlock>
          <AboutInfoBlockHeader>
            <AboutInfoBlockHeaderAmount>{completedTasks.length}</AboutInfoBlockHeaderAmount>
