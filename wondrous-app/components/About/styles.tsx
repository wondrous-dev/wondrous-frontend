...
export const MilestonesCardHeaderWonderIcon = styled(LogoSquare)`
	width: 40px;
	height: 40px;
`

export const CardHeaderName = styled(Typography)`
	&& {
		padding-left: 10px;
		width: 100%;
		font-weight: 600;
...
export const MilestonesCardAuthor = styled.div`
	width: 100%;
	display: flex;
	align-items: center;
`

export const MilestonesCardAuthorAvatar = styled.img`
	width: 30px;
	height: 30px;
	margin-right: 10px;
`

export const MilestonesCardAuthorPosition = styled(Typography)`
	&& {
		font-weight: 500;
		font-size: 13px;
		line-height: 17px;
...
export const MembersCardName = styled(Typography)`
	&& {
		margin-top: 10px;
		width: 100%;
		font-weight: 600;
...
export const MembersCardFooter = styled.div`
	max-width: 190px;
	width: 100%;
	min-height: 30px;
	height: 30px;
...
export const MembersCardFooterButton = styled(Button)`
	&& {
		padding: 6px 10px;
...
//completedTasks card
export const CompletedCardTitle = styled(MembersCardName)`
	&& {
		margin-top: 28px;
	}
`

export const CompletedCardText = styled(CardContent)`
	font-size: 14px;
	line-height: 19px;
	color: #c4c4c4;
	margin: 10px 0 15px;
