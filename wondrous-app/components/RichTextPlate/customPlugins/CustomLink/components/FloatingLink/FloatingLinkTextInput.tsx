...
import { AsProps, createComponentAs, createElementAs, HTMLPropsAs, mergeProps } from '@udecode/plate-core';

import { floatingLinkActions, floatingLinkSelectors } from './floatingLinkStore';

export const useFloatingLinkTextInput = (props: HTMLPropsAs<'input'>): HTMLPropsAs<'input'> => {
