...
import { floatingLinkActions, floatingLinkSelectors, useFloatingLinkSelectors } from './floatingLinkStore';

export const useFloatingLinkNewTabInput = (props: HTMLPropsAs<'input'>): HTMLPropsAs<'input'> => {
  const updated = useFloatingLinkSelectors().updated();
  const ref = useRef<HTMLInputElement>(null);
  const [checked, setChecked] = useState<boolean>(floatingLinkSelectors.newTab());
