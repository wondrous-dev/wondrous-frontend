import { getEditorString, getPluginType, isRangeAcrossBlocks, PlateEditor, someNode, Value } from '@udecode/plate-core';

import { ElementTypes } from 'components/RichTextPlate/typescript/plateTypes';
import { floatingLinkActions, floatingLinkSelectors } from '../components/FloatingLink/floatingLinkStore';
