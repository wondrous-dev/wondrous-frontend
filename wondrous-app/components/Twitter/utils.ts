...
export const DEFAULT_CHALLENGE_CODE = '0ioze5m20493ny2'; // not that important but should fetch from server
...
export const buildTwitterAuthUrl = (challengeCode = DEFAULT_CHALLENGE_CODE, state = 'state') => {
