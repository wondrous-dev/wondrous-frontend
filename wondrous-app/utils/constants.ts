...
export const DEFAULT_STATUS_FOR_MILESTONES = [TASK_STATUS_TODO];

export const STATUSES_ON_ENTITY_TYPES = {
  [ENTITIES_TYPES.TASK]: DEFAULT_STATUS_ARR,
  [ENTITIES_TYPES.MILESTONE]: DEFAULT_STATUS_FOR_MILESTONES,
  [ENTITIES_TYPES.BOUNTY]: DEFAULT_STATUS_ARR,
  [ENTITIES_TYPES.PROPOSAL]: DEFAULT_STATUS_ARR,
  DEFAULT: DEFAULT_STATUS_ARR,
};
