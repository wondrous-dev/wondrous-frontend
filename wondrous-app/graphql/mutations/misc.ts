...
export const CREATE_WAITLIST_USER = gql`
  mutation createWaitlistUser($phoneNumber: String!, $inviteRefCode: String) {
    createOrGetWaitlistUser(phoneNumber: $phoneNumber, inviteRefCode: $inviteRefCode) {
      token
      waitlistUser {
...
export const VERIFY_WAITLIST_USER = gql`
  mutation VerifyWaitlistUser($phoneNumber: String!, $verificationCode: String!) {
    verifyWaitlistUser(phoneNumber: $phoneNumber, verificationCode: $verificationCode) {
      token
      waitlistUser {
        ...LoggedinWaitlistUser
      }
