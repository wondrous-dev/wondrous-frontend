...
export function getMultisendAddress(type: ContractType, chainId: number) {
  switch (chainId) {
    ...
    case 8543:
      return CHAIN_TO_MULTISEND_ADDRESS[8543][type];
    case 56:
      return CHAIN_TO_MULTISEND_ADDRESS[56][type];
    default:
      return "";
  }
}
...
export const CHAIN_TO_NFT_FACTORY = {
  5: '0x25449b65659f479BD3895E3e0e6D53Fd9D830647',
  137: '0xa47d4bd8269e57148428fb522d3f93e85e66cccf'
}