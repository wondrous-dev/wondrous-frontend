...
const PurchaseCard = ({ purchase, discordRoles, storeItem, nftMetadata }) => {
  const username =
    ...
    >
      <Grid bgcolor="white" gap="18px" padding="14px" display="flex" flexDirection="column">
        ...
        <Grid display="flex" alignItems="center">
          {storeItem.type === STORE_ITEM_TYPES.NFT && nftMetadata ? (
            ...
            >
              <Box paddingBottom="10px" textAlign="start" width="100%">
