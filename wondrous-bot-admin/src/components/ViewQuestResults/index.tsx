		...
		>
			...
			>
				<Box flexBasis='40%' display='flex' flexDirection='column' gap='24px'>
					...
					<PanelComponent
						renderHeader={() => (
							<CampaignOverviewHeader title='Send quest notification' />
						)}
						renderBody={() => (
