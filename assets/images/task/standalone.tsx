...
const StandAlone = ({ style }) => (
  <Svg width={(style && style.width) || '36'} height={(style && style.width) || '36'} viewBox='0 0 18 18'  fill="none" xmlns="http://www.w3.org/2000/svg">
    <G clip-path="url(#clip0)">
    <Path d="M1.07987 13.9593L0.359187 16.3024L0.022245 17.397C-0.0876851 17.7541 0.246873 18.0887 0.604002 17.9787L1.69857 17.6418L4.04171 16.9211L1.07987 13.9593Z" fill="#DC8744"/>
