...
const AddFriend = ({ color=palette.grey800, style }) => {
  return (
      <Svg width={(style && style.width) || "28"} height={(style && style.width) || "28"} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={style}>
